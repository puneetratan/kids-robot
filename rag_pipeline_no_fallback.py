...
def generate_answer(query):
    ...
    if context_docs:
        ...
        # NO FALLBACK - model has nothing relevant but is still asked to answer!
        context = "No relevant information found in knowledge base."

    prompt = f"""Use the following information to answer the question in a fun, kid-friendly way with emojis and analogies.
